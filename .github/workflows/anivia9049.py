...
Original file is located at
    https://colab.research.google.com/drive/1OcbkxUNTB3XKjBqnZ_ixaRBl1aljzMR5
"""

!apt-get update > /dev/null 2>&1
!apt-get install chromium-chromedriver xvfb -y > /dev/null 2>&1
...
# Hàm để load ngẫu nhiên trang trên website và tạm dừng 3 đến 5 phút sau mỗi lần load
def load_random_page():
    ...
    while True:
        ...
        # Tạo thời gian ngẫu nhiên để tạm dừng giữa 3 đến 5 phút (180 giây đến 300 giây)
        wait_time = random.uniform(3 * 60, 5 * 60)
